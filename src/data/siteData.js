...
export const members = [
  ...
  { name: 'Amara Dubem', position: 'Financial Secretary', role: 'Policy Consultant', location: 'USA, Nigeria', phone: '234' },
  { name: 'Dominic Chigbo', position: 'Secretary', role: 'Realtor', location: 'Anambra, Nigeria', phone: '234', avatar: dominicAvatar },
  { name: 'Ozioma Uce Ndupu', position: 'Vice President', role: 'Educational Researcher', location: 'Port Harcourt, Nigeria', phone: '234' },
